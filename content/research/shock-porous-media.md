...
order: 3
summary: >-
  Stiff porous media act as a first-order low-pass filter on the pressure pulse that
  follows a shock, which lets us predict the load on a protected wall without new experiments.
image: shock-porous-media.jpg          # Wix file: porousexample.JPG
image_alt: Pressure traces behind a porous sample impinged by a shock wave
related:
  - Analysis of the pressure buildup behind rigid porous media
  - A simple constitutive model for predicting the pressure histories
  - On the pressure buildup behind an array of perforated plates
---
